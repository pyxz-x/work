...
public class SignConstants {
    ...
    public static final String MIDDLE_OUTPUT_X_MINI_WUA = "x-miniwua";
    ...
    public static final String MIDDLE_PARAM_API_NAME = "api_name";
    public static final String MIDDLE_PARAM_APPKEY = "appkey";
    public static final String MIDDLE_PARAM_AUTHCODE = "authCode";
    public static final String MIDDLE_PARAM_AUTH_CODE = "auth_code";

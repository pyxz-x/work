...
/* loaded from: /Users/a1/Desktop/cn.damai/classes20.dex */
public class MtopBusiness extends MtopBuilder {
    ...
    /* compiled from: Taobao */
    /* renamed from: com.taobao.tao.remotebusiness.MtopBusiness$1 */
    ...
    /* JADX WARN: Removed duplicated region for block: B:72:0x008e A[Catch: all -> 0x00ba, TryCatch #0 {all -> 0x00ba, blocks: (B:69:0x007e, B:71:0x0082, B:73:0x0097, B:75:0x009d, B:77:0x00a6, B:79:0x00ad, B:72:0x008e), top: B:91:0x007e }] */
    /*
    ...
    */
    ...
    public void doFinish(MtopResponse mtopResponse, BaseOutDo baseOutDo) {
        ...
        if (TBSdkLog.isLogEnable(TBSdkLog.LogEnable.InfoEnable)) {
            ...
            sb2.append((Object) this.request);
        ...
        long jCurrentTimeMillis = this.stat.currentTimeMillis();
        MtopStatistics mtopStatistics = this.stat;
        mtopStatistics.callbackPocTime = jCurrentTimeMillis - mtopStatistics.netSendEndTime;
        mtopStatistics.allTime = jCurrentTimeMillis - mtopStatistics.startTime;
        ...
        try {
            ...
            if (MtopMonitor.getInstance() != null) {
                ...
                map.put(IMtopMonitor.DATA_RESPONSE, mtopResponse.getApi());
                MtopMonitor.getInstance().onCommit(IMtopMonitor.MtopMonitorType.TYPE_CALLBACK, map);
            }
        } catch (Throwable th) {
    ...
    public void doStreamFinish(MtopResponse mtopResponse, BaseOutDo baseOutDo) {
        ...
        TBSdkLog.d(TAG, this.mtopContext.seqNo, "[doStreamFinish] callback");
            ...
            try {
                try {
                    ...
                    try {
                        ...
                        if (mtopResponse2 == null || mtopResponse2.getResponseCode() != -9 || (apiID2 = this.mtopContext.apiId) == null || apiID2.getCall() == null) {
                            return;
                        }
                        this.mtopContext.apiId.getCall().cancel();
                        return;
                    } catch (Throwable th2) {
                        try {
                            MtopResponse mtopResponse3 = this.mtopResponse;
                            if (mtopResponse3 != null && mtopResponse3.getResponseCode() == -9 && (apiID = this.mtopContext.apiId) != null && apiID.getCall() != null) {
                                this.mtopContext.apiId.getCall().cancel();
                            }
                        } catch (Throwable th3) {
                            TBSdkLog.e(TAG, this.seqNo, "doStreamFinish listener cancel error", th3);
                        }
                        throw th2;
                    }
                }
        ...
        if (mtopResponse == null || !mtopResponse.isApiSuccess()) {
            if (!this.mForbidStreamExceptionCallback && mtopResponse != null && mtopResponse.getStreamModeData() == null) {
                ...
                iMtopStreamListener.onReceiveData(StreamResponseConvert.convertStreamResponse(mtopResponse), baseOutDo, this.requestType, getReqContext());
            }
            iMtopStreamListener.onError(StreamResponseConvert.convertStreamErrorEvent(mtopResponse), this.requestType, getReqContext());
            MtopResponse mtopResponse4 = this.mtopResponse;
            if (mtopResponse4 == null || mtopResponse4.getResponseCode() != -9 || (apiID3 = this.mtopContext.apiId) == null || apiID3.getCall() == null) {
                return;
            }
            this.mtopContext.apiId.getCall().cancel();
            return;
        ...
        try {
            ...
            iMtopStreamListener.onFinish(StreamResponseConvert.convertStreamFinishEvent(mtopResponse), this.requestType, getReqContext());
        } catch (Throwable th5) {
            TBSdkLog.e(TAG, this.seqNo, "listener onSuccess callback error", th5);
        }
        if (TBSdkLog.isLogEnable(TBSdkLog.LogEnable.InfoEnable)) {
            TBSdkLog.i(TAG, this.seqNo, "listener onSuccess callback.");
        }
        try {
            MtopResponse mtopResponse5 = this.mtopResponse;
            if (mtopResponse5 == null || mtopResponse5.getResponseCode() != -9 || (apiID4 = this.mtopContext.apiId) == null || apiID4.getCall() == null) {
                return;
            }
            this.mtopContext.apiId.getCall().cancel();
        } catch (Throwable th6) {
    ...
    public void doStreamReceiveData(MtopResponse mtopResponse, BaseOutDo baseOutDo) {
        ...
        try {
            ...
            IMtopStreamListener iMtopStreamListener = (IMtopStreamListener) this.listener;
            TBSdkLog.d(TAG, this.mtopContext.seqNo, "[doStreamReceiveData] callback");
            long jCurrentTimeMillis = System.currentTimeMillis();
            mz2 mz2VarConvertStreamResponse = StreamResponseConvert.convertStreamResponse(mtopResponse);
            MtopStatistics mtopStatistics = this.stat;
            ...
            TBSdkLog.d(TAG, this.mtopContext.seqNo, "[doStreamReceiveData] convertStreamResponse: " + (System.currentTimeMillis() - jCurrentTimeMillis));
            iMtopStreamListener.onReceiveData(mz2VarConvertStreamResponse, baseOutDo, this.requestType, getReqContext());
        } catch (Throwable th) {
    ...
    public MtopBusiness setPageIndex(int i) {
        return (MtopBusiness) super.setPageIndex(i);
    }
    ...
    public MtopBusiness supportStreamJson(boolean z) {
        return (MtopBusiness) super.supportStreamJson(z);
    }

    @Override // mtopsdk.mtop.intf.MtopBuilder
    public MtopBusiness supportZstdDictionary(boolean z) {
        return (MtopBusiness) super.supportZstdDictionary(z);
    }
    ...
    public MtopBusiness upstreamCompress(boolean z) {
        return (MtopBusiness) super.upstreamCompress(z);
    }
    ...
    public void startRequest(int i, Class<?> cls) {
        ...
        if (TBSdkLog.isLogEnable(TBSdkLog.LogEnable.InfoEnable)) {
            TBSdkLog.i(TAG, this.seqNo, "startRequest " + ((Object) this.request));
        }

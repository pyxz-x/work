...
def getOrderBuildParams(lzh_t):
    ...
    with open("/Users/a1/Desktop/work2/work/damai/frida_code/get_order_build_params.js", "r", encoding="utf-8") as f:
        js_code = f.read()
    ...
    if extracted_params:
        ...
        script.unload()
        session.detach()
# a = getParams('clh+aHZUUQFqRV14SVtvcHBfeWZ3X14NZUdOfU5OZ35zUnxqd15YCHA7IxMqMBMEBjUcCgA5PGtwBwY5KA03JjQDOzckHlMLYU1ddE5Abn1mCSAyLgNSDWM=')
# print(a)

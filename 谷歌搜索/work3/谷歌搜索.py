...
if __name__ == "__main__":
    ...
    data_jsons = []
    with open(
            "site_bangdan_keywords_select_youxian1_ustc.json", "r", encoding="utf-8"
    ) as f:
        datas = f.readlines()
        for data in datas:
    ...
    if os.path.exists("finished_home.json"):
        finished_json = open("finished_home.json", "r", encoding="utf-8")
